...
const apiKey = 'ONKsBK18KNfXbv0AZFvAVVbpDChvQ4aL'
const url = `http://dataservice.accuweather.com/forecasts/v1/daily/5day/54400_PC?apikey=${apiKey}&details=true&metric=true`
